...
//        testExtractor(new GeneralExtractor(), new URL("http://www.sony.com/electronics/cyber-shot-compact-cameras/dsc-rx1rm2/specifications"));
//
//        //NIKON
//        testExtractor(new GeneralExtractor(), new URL("http://www.nikonusa.com/en/nikon-products/product/dslr-cameras/d5500.html#tab-ProductDetail-ProductTabs-TechSpecs"));
...
//
//        //VISIONS
//        testExtractor(new GeneralExtractor(), new URL("http://www.visions.ca/catalogue/category/Details.aspx?categoryId=686&productId=28317&sku=P530BREFURB"));
//        testExtractor(new GeneralExtractor(), new URL("http://www.visions.ca/catalogue/category/Details.aspx?categoryId=223&productId=30395&sku=SX420IS"));
//        testExtractor(new GeneralExtractor(), new URL("http://www.visions.ca/catalogue/category/Details.aspx?categoryId=223&productId=27458&sku=S3700BLACK"));
//
//        //SIGMA PHOTO
//        testExtractor(new GeneralExtractor(), new URL("https://www.sigmaphoto.com/cameras/mirrorless/sd-quattro-camera"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.sigmaphoto.com/cameras/compact/dp1-quattro-compact-digital-camera"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.sigmaphoto.com/cameras/compact/dp2-merrill-compact-digital-camera"));
//
//        //RICOH
//        testExtractor(new GeneralExtractor(), new URL("http://us.ricoh-imaging.com/index.php/cameras/pentax-645z"));
//        testExtractor(new GeneralExtractor(), new URL("http://us.ricoh-imaging.com/index.php/cameras/wg-m2"));
//        testExtractor(new GeneralExtractor(), new URL("http://us.ricoh-imaging.com/index.php/cameras/pentax-k-s2"));
//        testExtractor(new GeneralExtractor(), new URL("http://us.ricoh-imaging.com/index.php/cameras/gr-2"));
//        testExtractor(new GeneralExtractor(), new URL("http://us.ricoh-imaging.com/index.php/cameras/pentax-k-1"));
//
//        //DPPREVIEW
//        testExtractor(new GeneralExtractor(), new URL("https://www.dpreview.com/products/fujifilm/slrs/fujifilm_xa3/specifications"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.dpreview.com/products/canon/slrs/canon_eosm6/specifications"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.dpreview.com/products/sony/compacts/sony_dscrx100m5/specifications"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.dpreview.com/products/canon/slrs/canon_eos77d/specifications"));
//
//        //NEW EGG
//        testExtractor(new GeneralExtractor(), new URL("https://www.newegg.com/Product/Product.aspx?Item=9SIABKX58W3053"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.newegg.com/Product/Product.aspx?Item=9SIAB2G5515538"));
//        testExtractor(new GeneralExtractor(), new URL("https://www.newegg.com/Product/Product.aspx?Item=9SIAB925C69394"));
//
//        //CURRYS
...
//        testExtractor(new GeneralExtractor(), new URL("http://www.currys.co.uk/gbuk/cameras-and-camcorders/digital-cameras/dslr-and-compact-system-cameras/canon-eos-80d-dslr-camera-black-body-only-10145630-pdt.html"));
//        testExtractor(new GeneralExtractor(), new URL("http://www.currys.co.uk/gbuk/cameras-and-camcorders/digital-cameras/dslr-and-compact-system-cameras/nikon-d7200-dslr-camera-black-body-only-10124382-pdt.html"));
//
//        //WEX PHOTO GRAPHIC
...
//        testExtractor(new GeneralExtractor(), new URL("http://www.wexphotographic.com/canon-eos-7d-mark-ii-digital-slr-camera-body-1560196/"));
//        testExtractor(new GeneralExtractor(), new URL("http://www.wexphotographic.com/pentax-k-1-digital-slr-camera-body-1592180/"));
//        testExtractor(new GeneralExtractor(), new URL("http://www.wexphotographic.com/canon-eos-5d-mark-iii-digital-slr-camera-body-1530010/"));
    }
